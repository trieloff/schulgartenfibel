export const areSameTagNames = (el1 = {}, el2 = {}) => el1.tagName && el2.tagName && el1.tagName === el2.tagName;
...
export const objectToStyleString = (styles = {}) => Object.entries(styles).map(([propName, propValue]) => `${camelCaseToDash(propName)}: ${propValue}`).join(';');
