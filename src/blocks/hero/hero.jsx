...
class HelixHero extends Component {
  render() {
    const scrollTo = (e) => {
      ...
      switch (direction) {
        case 'prev': this.current--;break;
        case 'next': this.current++;break;
        default: this.current = +(direction.replace(/[^\d]/g, ''));break;
      }
    ...
    return (
      <div class="hero-2 js-hero-2">
        <div class="hero-2-slider js-hero-2-slider">
          <div class="hero-2-slide" id="slide1">
          ...
          <div class="hero-2-slide" id="slide2">
            <div class="hero-2-container container">
              <div class="hero-2-group"><a class="hero-2-play play play_black" href="#" data-video="PYBmAzhTecU">
                <div class="play-icon"><svg class="icon icon-play" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 18">
                  <path d="M1 18c-.17 0-.35-.04-.5-.13A1 1 0 0 1 0 17V1A1 1 0 0 1 .5.13a1 1 0 0 1 1 0l13.86 8a1 1 0 0 1 0 1.73l-13.86 8c-.15.1-.33.13-.5.13h0z" /></svg></div>
          ...
          <div class="hero-2-slide" id="slide3">
            <div class="hero-2-container container">
              <div class="hero-2-group"><a class="hero-2-play play play_black" href="#" data-video="PYBmAzhTecU">
                <div class="play-icon"><svg class="icon icon-play" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 18">
                  <path d="M1 18c-.17 0-.35-.04-.5-.13A1 1 0 0 1 0 17V1A1 1 0 0 1 .5.13a1 1 0 0 1 1 0l13.86 8a1 1 0 0 1 0 1.73l-13.86 8c-.15.1-.33.13-.5.13h0z" /></svg></div>
        ...
        <div class="hero-2-foot">
          <div class="hero-2-container container">
            <div class="hero-2-arrows arrows arrows_sm">
              <button onClick={scrollTo} class="arrows-item js-hero-2-prev"><svg class="icon icon-arrow-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 9">
                <path d="M5 6.9c.4.4.4 1 0 1.4h0c-.4.4-1 .4-1.4 0L.3 5a1 1 0 0 1 0-1.4L3.6.3A1 1 0 0 1 5 .3h0a1 1 0 0 1 0 1.4L3.4 3.3H17a1 1 0 0 1 1 1h0a1 1 0 0 1-1 1H3.4L5 6.9z" /></svg></button>
              <button onClick={scrollTo} class="arrows-item js-hero-2-next"><svg class="icon icon-arrow-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 9">
            ...
            <div class="hero-2-posts"><a class="hero-2-post" href="#slide2" onClick={scrollTo} >
              <div class="hero-2-preview"><img class="hero-2-pic" src="img/bg-image-1.jpg" alt="Image 5" /></div>
              <div class="hero-2-details">
                <div class="hero-2-label label" href="#">Design</div>
                <div class="hero-2-content content">Make it simple but significant</div>
              </div>
            </a><a class="hero-2-post" href="#slide3" onClick={scrollTo} >
                <div class="hero-2-preview"><img class="hero-2-pic" src="img/bg-image-10.jpg" alt="Image 6" /></div>
                <div class="hero-2-details">
                  <div class="hero-2-label label" href="#">Health</div>
                  <div class="hero-2-content content">Yeezy Boost 350 V2 Clay</div>
                </div>
              </a></div>
          </div>
        </div>
